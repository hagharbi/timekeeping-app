                ...
                <CardHeader>
                  <Row>
                    <Col className="text-left" sm="6">
                      <h5 className="card-category">Number of (Week)</h5>
                      <CardTitle tag="h2">Completed Tasks</CardTitle>
                    </Col>
                    <Col sm="6">
                      <ButtonGroup
          ...
          <Row>
            <Col lg="8" md="12">
              <Card className="card-tasks">
                <CardHeader>
                  <h4 className="title d-inline">HIGH PRIORITY PROJECTS (5)</h4>
                  <h5 className="card-category d-inline"> today</h5>
                  <UncontrolledDropdown>
                    <DropdownToggle
                      caret
                      className="btn-icon"
            ...
            <Col lg="4">
              <Card className="card-chart">
                <CardHeader>
                  <h4 className="card-category">Week Earnings</h4>
                  <CardTitle tag="h3">

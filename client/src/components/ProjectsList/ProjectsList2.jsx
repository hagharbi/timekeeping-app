...
let counter = 0;
function createData(title, client, category, priority, status) {
    counter += 1;
    return { id: counter, title, client, category, priority, status };
}
...
class EnhancedTable extends React.Component {
    state = {
        ...
        selected: [],
        data: [
            createData("Front-End", "Sumit", "Web App", "High", "Active"),
            createData("Title 2", "Techaround", "Web Design", "Medium", "Active")
        ],
        page: 0,
        rowsPerPage: 5
    };
                                ...
                                .map(n => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <TableCell align="left">{n.priority}

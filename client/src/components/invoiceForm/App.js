    ...
    return (
      <div className="wrapper">
        <div className="download-container">
          <ReactToPrint
            trigger={() => (
              <a href="#" alt="download button" className="download-btn" id="download-btn">
                Print this out!
              </a>
            )}
        ...
        <div className="container" ref={el => (this.componentRef = el)}>
          <div className="text-container">
            <div className="text left">
              <h2 className="invoice-title" style={{pointerEvents: "none"}}>sumit <span style={{fontWeight: "400"}}>invoice</span></h2>
